...
//conex�o ao banco
    ...
    //novo php7
    //$conexao = mysqli_connect('localhost','u898756788_psppgartes',':2!2g6G#','u898756788_psppgartes', '3306');
    
//2022 ufpa $conexao = mysqli_connect('localhost','psppgartes','u7HQ9j8KjI','st_psppgartes', '3306');
