...
/*
 *  MAPEANDO DADOS DO FORMULÁRIO PARA VARIÁVES
        ...
        <div id="form_container">
            ...
            <form id="form_98277" class="appnitro"  method="post" action="">
                <div class="form_description">
                    <h2>PSPPGARTES</h2>
                    <p>Formulário de Solicitação de Inscrição - Edital 2021</p>
                </div>						
                <ul >
                    ...
                    if ($data['TOTAL'] !== "0")
                        {
                        die("O CPF '$txtCPF' já foi cadastrado para o PSPPGARTES 2021<p><a href='http://www.ppgartes.propesp.ufpa.br/'>www.ppgartes.propesp.ufpa.br</a></p>");
                        }
                    ...
                    ?>
                    <!--h3>Processando dados do formulário de inscrição</h3-->
                    <p></p>
                    <?php
                    /*
...
// =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
                    ...
                    $mail->Username = 'naoresponder@psppgartes.4gestor.net'; // Usuário do servidor SMTP
...
//EMAIL DO INSCRITO
                    ...
                    $mail->AddBCC('alexmota.br@gmail.com', 'Alexandre PPGARTES');
                    $mail->Subject = "PSPPGARTES2021 - Confirmação de Inscrição de " . $txtNome; // Assunto da mensagem
