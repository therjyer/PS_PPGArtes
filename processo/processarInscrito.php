        ...
        <div id="form_container">
            ...
            <form id="form_98277" class="appnitro"  method="post" action="">
                ...
                <ul >
                    ...
                    // #2023 
                    //$conn = mysqli_connect('localhost', 'u613711144_psppgartes', ':2!2g6G#', 'u613711144_psppgartes');
                    ...
                    foreach ($_FILES["Anexos"]["error"] as $key => $error) {
                        if ($error == UPLOAD_ERR_OK) {
                            ...
                            //#local $linkemail = "<a href = 'http://localhost/psppgartes/up2024/$name_target' target = '_blank'>$name</a>";
...
//$mail->Body
                    ...
                    $textoEmail = "<p>DEMONSTRAÇÃO Novo Cadastro no Sistema do Processo Seletivo do PPGARTES - 2024.</p>" .
...
//EMAIL DO INSCRITO
                    ...
                    $mail->AddBCC('alexmota.br@gmail.com', 'Alexandre PPGARTES');
                    $mail->Subject = "DEMONSTRAÇÃO DO PSPPGARTES2024 - Confirmação de Inscrição de " . $txtNome; // Assunto da mensagem
