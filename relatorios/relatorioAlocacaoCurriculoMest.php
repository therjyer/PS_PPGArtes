...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        //per�odo da busca
        $periodo = " PROCESSO SELETIVO " . $processo . " - RELAT�RIO DE ALOCA��O PARA AVALIA��O DE CURR�CULO (MESTRADO)";
        $pdf->setXY(1.5, 2);
...
for ($i = 0; $i < $total_results; $i++) {
    ...
    $idProfessor1 = mysql_result($result, $i, 'avaliadorCurriculo1');
    ...
    $idProfessor2 = mysql_result($result, $i, 'avaliadorCurriculo2');
...
$pdf->Output("Relat�rio de Aloca��o de Projeto(Processo Seletivo " . $processo . ").pdf", "I");
?>